...
#对抗样本生成类
class Attack_Black():
    def __init__(self, net, net1,criterion):
        self.net = net
        self.net1 = net1
    ...
    def fgsm(self, x, y, eps, targeted=False,x_val_min=-1, x_val_max=1):
        ...
        h = self.net1(x)
        h_adv = self.net1(x_adv)

        return x_adv, h_adv, h
        

    def i_fgsm(self, x, y, eps, iteration, alpha=1,targeted=False,  x_val_min=-1, x_val_max=1):
        x_adv = Variable(x.data, requires_grad=True)
