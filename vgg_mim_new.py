...
#                acc_num = acc_num+1 
    ...
    time_end = time.time()
    print("eps:" + str(eps/2) +"    iteration:"+ str(iteration) + "    acc_num:" + 
          str(acc_num) + "    acc_rate:" + str(acc_rate) + '   time:' + str(time_end - time_begin))
